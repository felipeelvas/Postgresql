...
function perform_backups()
{
	...
	SCHEMA_ONLY_DB_LIST=`set PGPASSWORD="$PASSWORD" && psql -h "$HOSTNAME" -U "$USERNAME" -At -c "$SCHEMA_ONLY_QUERY" postgres`
	...
	for DATABASE in `set PGPASSWORD="$PASSWORD" && psql -h "$HOSTNAME" -U "$USERNAME" -At -c "$FULL_BACKUP_QUERY" postgres`
	do
